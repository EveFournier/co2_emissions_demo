...
# there is a Specific Warnings in Code i want to suppress
...
table_df["Absolute_Change"] = table_df["2022"] - table_df["2000"]

# Calculate relative change as the absolute change divided by the 2000 emissions, then multiplied by 100
table_df["Relative_Change"] = (
    (table_df["2022"] - table_df["2000"]) / table_df["2000"] * 100
)
...
table_df["Relative_Change"] = table_df["Relative_Change"].round(0).astype(str) + "%"
...
emissions_long_subset = emissions_long_1990_2022.query(
    'country=="France" | country=="Switzerland" | country=="Germany" | country=="Italy" | country=="Spain"'
)
...
fig_chart = px.line(
    ...
    labels={"country": "Country", "year": "Year", "emissions": "CO2 emissions (tons)"},
)
